  ...
  const timeline = [
    {
      ...
      desc: 'SDGKU technical diploma. Fifteen solo-built production applications — Django, FastAPI, React, TypeScript, PostgreSQL, automated tests, and CI/CD on Railway.',
    },
    {
      icon: '🔒',
