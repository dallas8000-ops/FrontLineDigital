  ...
  const timeline = [
    {
      ...
      desc: 'SDGKU technical diploma. Twelve solo-built production applications — Django, FastAPI, React, TypeScript, PostgreSQL, automated tests, and CI/CD on Railway.',
    },
    {
      icon: '🔒',
